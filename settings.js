...
//Apikey Recaptcha https://www.google.com/recaptcha/about/ or https://www.google.com/recaptcha/admin
...
loghandler = {
    ...
    instgram: {
	    status: false,
	    code: 403,
	    message: '[!] Forbiden or Error, Username Tidak Ada',
	    maintanied_by: `${creator}`
   },
    register: {
	    status: false,
